...
def run(params):
    if not os.path.exists(params["default_train_path"]):
        parser_mnist_data(params["default_data_path"])
    ...
    parser.add_argument('--train_limit', type=int, default=params["default_train_limit"], help='Train data size in each category')
    parser.add_argument('--test_limit', type=int, default=params["default_test_limit"], help='Test data size in each category')
